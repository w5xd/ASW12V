...
namespace WS7I_antennas_shortcuts
{
    // class to present the WS7I_antennas form under WriteLog's keyboard shortcut
        ...
        ,IDisposable
    {
        ...
        protected abstract WS7I_antennas.GetSerial getSerial();
        ...
        private void GuiThreadEntry(System.Threading.ManualResetEvent e)
        {
            ...
            WS7I_antennas.WS7I_ratpak form = new WS7I_antennas.WS7I_ratpak(getSerial(), e);
        ...
        , WriteLogRemoteControlShortcuts.IRemoteSiteShortcutRpc
    {
        ...
        protected override WS7I_antennas.GetSerial getSerial()
        {
            return (Form f) => { return new WS7I_antennas.SerialPortHandler(f); };
        }
...
#region IControlSiteShortcutRpc
        ...
        public String KeyAtRemote { get
            { return "WS7I_antennas_shortcuts.WriteLogKeyProcessor=WS7I_antennas_shortcuts"; } }
